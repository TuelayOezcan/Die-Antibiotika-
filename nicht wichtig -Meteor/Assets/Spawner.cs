...
public class Spawner : MonoBehaviour {
    ...
    int randMeteor; //pick a random enemy
    ...
    IEnumerator waitSpawner()
    {
        ...
        while (!stop) //true forever
        {
            ...
            Vector3 spawnPosition = new Vector3(Random.Range(-spawnValues.x, spawnValues.x),20,Random.Range(-spawnValues.z, spawnValues.z));
